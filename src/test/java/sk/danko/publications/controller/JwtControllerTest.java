...
import static sk.danko.publications.controller.JwtController.LOGIN_URI;
import static sk.danko.publications.controller.JwtController.REGISTER_URI;
...
class JwtControllerTest {
    ...
    void testRegister_success() throws Exception {
        ...
        when(userDetailService.register(any(UserModel.class))).thenReturn(savedUser);
        ...
        verify(userDetailService, times(1)).register(any(UserModel.class));
    }
    ...
    void testGenerateToken_success() throws Exception {
        ...
        // Mock authenticate, vráti rovnaký token, aby nehodilo výnimku
